...
#include "Items/PYSword.h"
#include "Characters/PYPlayer.h"
#include "Games/PYPlayerState.h"

void APYSword::OnSphereOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
